...
Note that all commercial and open-source macropads that I have examined use configuration file or files, to store macros and or chained macros, definitions and scripts. This macropad use individual files and more importantly symbolic link files, which offers customisation options that other macropads cannot easily duplicate with giant or tiny JSON or XML files.
