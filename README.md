...
<img src="images/RP2350-Touch-LCD-Cased.jpg" height="30"/> The [**capacitive touch RP2350B LCD of choice**](https://www.waveshare.com/RP2350-Touch-LCD-3.5.htm) also has an ES8311 audio codec that can play large 16bit PCM files saved on the SDCard. This [**version with a case**](https://www.waveshare.com/rp2350-touch-lcd-3.5.htm?sku=33896) is very flat at 12mm, and is therefore suitable to use lying flat - provided no I²C peripherals are plugged into the expander at the back of the case. Use the rotate 180 control code \*ro\* to have the USB cable on the right-hand side - no calibration is required for the FT6336 touch controller used in this LCD.
